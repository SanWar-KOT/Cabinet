...
<h1><?= Html::encode($this->title)?> </h1>
 <?php Pjax::begin(); ?>
<?php $form = ActiveForm::begin(['id' => 'NewForm', 'options' => ['data-pjax' => true], 'action'=>['reitingprepod/seach']]); ?>
<h3><?= $md5 ?></h3>
<div class="site-about">
<hr />
<p>Фамилия, Имя, Отчество: <?= Yii::$app->user->identity->FIO ?></p>
<?= $form->field($model, 'login')->hiddenInput(['value' => Yii::$app->user->identity->FIO])->label(false); ?>
<?= $form->field($model, 'kafedra')->dropDownList(['Экономики и управления' => 'Экономики и управления', 'Профсоюзного движения, гуманитарных и социально-экономических дисциплин' => 'Профсоюзного движения, гуманитарных и социально-экономических дисциплин'])->label('Кафедра: ') ?> 
<?= $form->field($model, 'yearrs')->dropDownList(['2016/2017' => '2016/2017', '2017/2018' => '2017/2018'])->label('Учебный год: ') ?> 
...
<?= $form->field($model, 'rz')->hiddenInput()->label(''); ?>
...
$('#NewForm').attr('action', '/reitingprepod/seach');
document.getElementById("kostil").style.display = "block";
});
$("#saves-button").click(function(){ 
$('#NewForm').attr('action', '/reitingprepod/saves');
});
</script>
